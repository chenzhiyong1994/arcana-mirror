...
- **流程影响**：新建产品，无旧流程迁移；
- **数据影响**：每日牌与已完成主题解读自动进入当前设备最近 30 条历史，均视为私密内容；用户可单条删除或全部清空；
...
设置页包含：CloudBase AI 与 `hy3` 说明、娱乐与自我探索声明、AI 数据边界、本地历史说明、分别清空本地历史和重置图鉴、项目版本和素材说明。
