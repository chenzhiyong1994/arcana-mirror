...
围绕“提出困扰—选择单牌或三牌—抽牌—情境化解读—记录行动—点亮图鉴”构建本地闭环；将 AI 限定为解释和反思辅助者，用结构化输出、安全策略、规则校验和本地降级保障体验。v0.2 覆盖 22 张大阿尔卡那、单牌及三牌解读；回访与更多牌阵继续后置。
...
| 9 | 图鉴 | 22 张大阿尔卡那按实际翻牌解锁、总览和详情 | P0 · v0.2 |
...
**包含：**22 张大阿尔卡那正式卡面、正逆位、单牌、三牌、每日一牌、CloudBase AI 问题聚焦解读、本地降级、可选本地历史、图鉴收集、安全分类，以及支持定位故障的最小日志。

**暂不包含：**日记、云端历史、显式账号系统、三牌之外的更多牌阵、56 张小阿尔卡那、回访、完整埋点体系、自动化 E2E、真人服务、社区、支付、会员、广告、星盘/八字、复杂提醒、卡牌养成、运营后台。
...
图鉴按序号展示 22 张大阿尔卡那。实际翻开后才解锁图像和详情，并记录翻开次数、已见正逆位；未解锁卡使用统一卡背遮挡。详情展示图像、关键词、正位含义、逆位含义和一个自我反思问题。图鉴独立于历史，不提供系统课程、考试或付费养成。
