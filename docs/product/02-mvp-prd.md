...
**包含：**22 张大阿尔卡那正式卡面、正逆位、单牌、三牌、每日一牌、主题解读、多维结构化模拟解读、本地降级、可选本地历史、图鉴收集、安全分类，以及支持定位故障的最小日志。

**暂不包含：**日记、CloudBase、真实 AI、账号系统、三牌之外的更多牌阵、56 张小阿尔卡那、回访、完整埋点体系、自动化 E2E、真人服务、社区、支付、会员、广告、星盘/八字、复杂提醒、卡牌养成、运营后台。
...
设置页包含：模拟 AI 说明、娱乐与自我探索声明、本地数据说明、分别清空本地历史和重置图鉴、项目版本和素材说明。
...
2. 确认牌面素材授权或原创计划；
3. 本地模拟阶段用契约和安全测试覆盖单牌、三牌与降级；接入真实 AI 前建立至少 40 条单牌/三牌发布评估集；
