...
> 本轮 22 张大阿尔卡那完整生成已选用 A；G 继续保留为备选，不混入 A 批次。
...
按 [`../../../deliverables/style-a-deck-generation-kit/README.md`](../../../deliverables/style-a-deck-generation-kit/README.md) 先制作统一正面框、独立卡背和隐士试产，试产通过后再完成 22 张纯牌面插画；生成结果必须执行逐牌语义和整套一致性验收。
